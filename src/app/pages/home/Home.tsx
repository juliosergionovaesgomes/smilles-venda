...
const Home = () => {
  return (
    <div className="text-white w-full flex items-center justify-center flex-col ">
      ...
      {/* Conteúdo */}
      <div className="w-full h-screen   items-center  h-auto flex  flex-wrap sm:flex-nowrap  sm:h-screen justify-between  py-20 space-x-4 flex-col">
        <h1 className="uppercase text-2xl font-semibold">
          O Que você vai aprender no curso{' '}
          <b style={{ color: '#f9004d' }}>O Código das Milhas</b> ?
        </h1>
            ...
            <div className="flex w-full h-full border border-neutral-800 flex-col relative items-center justify-end ">
              ...
              <div className="flex w-full h-full flex-col items-center bg-neutral-900 bg-opacity-60 justify-end absolute z-50">
                ...
                <div className="flex  flex-col items-center justify-center  space-y-2 py-2 pb-3">
                  <h4 className="text-center font-semibold text-2xl leading-6	 ">
                    Introdução ao <br />
                    Código das Milhas
                  </h4>
                  <span className="text-xs font-thin">
                    O <b style={{ color: '#f9004d' }}>Código</b> das Milhas
                  </span>
                </div>
              </div>
            </div>
            <button
              className="w-full px-4 py-2 text-xs bg-neutral-800 hover:scale-90"
              style={{ fontFamily: 'SoulcraftGX', backgroundColor: '#1ED760' }}
            >
              Acessar
            </button>
          </div>
