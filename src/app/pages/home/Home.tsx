...
const duvidas = [
  {
    ...
    description:
      'Claro! Você vai aprender os códigos das viagens baratas com acúmulos de milhas de forma estratégica e montar seu roteiro sem desperdiçar seu dinheiro e/ou milhas.',
  },
  {
    title: 'Por quanto tempo tenho acesso ao curso?',
    description:
      'Seu acesso será vitalício ao curso onde poderá tirar suas dúvidas pela própria plataforma.',
  },
  {
    title: 'Sou iniciante, esse curso é para mim?',
    description:
      'Sim, no curso você aprende os conceitos básicos de milhas e tudo que você precisa para montar um roteiro perfeito, inclusive, emissões com a Latam, Smiles e Tudo Azul sempre fazendo a comparação em dinheiro.',
  },
  {
    title: 'Dentro do curso, você ensina exemplos na prática?',
    description:
      'Sim! Durante o conteúdo vocês irão terão acesso à todas estratégias de acúmulos, roteiros e emissões na prática.',
  },
];
  ...
  return (
    <div className="text-white w-full flex items-center justify-center flex-col ">
      ...
      <div className="w-full h-screen flex  items-center justify-center space-y-6  flex-col ">
        <h1 className="text-4xl w-full  text-white font-bold  text-center">
      ...
      <div className="w-full h-auto flex  flex-wrap sm:flex-nowrap  sm:h-screen items-center justify-center  bg-neutral-black flex-row">
        ...
        <div className="w-full h-full px-32 py-5  flex flex-col items-center justify-center">
          {[1, 2, 3, 4].map((element) => (
            <div
              key={element}
              className={`w-full h-32 flex flex-row hover:delay-100 hover:transition-transform hover:translate-x-2 space-x-10 items-center justify-start   p-6  ${
                element === [1, 2, 3, 4].length
                  ? ''
      ...
      <div className="w-full  h-screen items-center flex-wrap flex justify-center  space-x-4 space-y-20 flex-col bg ">
        ...
        <div className="flex flex-wrap  justify-center items-center  gap-10">
          {modulos.map((module) => (
            <div className="w-56 h-96  flex  flex-col items-center justify-end ">
              <div className="flex w-full h-full border rounded-lg shadow-sm border-neutral-800 flex-col relative items-center justify-end ">
                ...
                <div className="flex w-full h-full flex-col items-center bg-neutral-900 bg-opacity-60 justify-end absolute z-50">
                  <span
                    className="px-2 font-bold rounded-md  shadow-sm flex items-center justify-center  text-black text-sm "
                    style={{ backgroundColor: '#f9004d' }}
                  >
                    MÓDULO {module.modulo}
                  </span>
                  <div className="flex  flex-col items-center justify-center pb-2 ">
                    <h4 className="text-center font-semibold text-lg leading-6">
                      {module.title1}
                      <br />
                      {module.title2}
                    </h4>
              ...
              <button
                className="w-full animate-pulse px-4 py-2 text-xs mt-3 rounded-md border border-neutral-800 bg-neutral-900 "
      ...
      <div className="w-full h-screen flex  flex-col text-white items-center justify-center px-10  text-center">
        ...
        <div className="flex w-full items-center justify-center flex-col space-y-4">
          <h1 className="text-4xl  font-bold leading-10 text-center">
            Tudo isso por um <br />
            preço justo!
          </h1>
          <div>
            <span className="text-lg space-x-1">
              ...
              <span className="font-bold text-3xl" style={{ color: '#f9004d' }}>
                R$9,74
              </span>
              <span className="font-bold">no cartão</span>
            </span>
            <br />
            <span className="text-lg font-bold">
              ou <span>R$97,00</span> à vista
            </span>
          </div>
          <button
            className="z-50  text-sm uppercase font-bold text-black  rounded-lg p-4 hover:scale-90"
          ...
          <p className="w-2/2 text-center text-lg">
            Você terá um ano de acesso ao curso podendo assistir aonde
            <br /> e quando quiser com suporte a todas as aulas.{' '}
          </p>
        </div>
      </div>
      ...
      <div className="w-full h-screen flex flex-row justify-center items-center">
        ...
        <div className="w-2/5 space-y-4">
          <h4 className="text-4xl font-bold ">
            Você conta com a garantia <br /> incondicional de 7 dias
          </h4>
          <p className="text-justify text-md leading-5">
            Se por qualquer motivo você não gostar, achar que não é para você,
            <b className="text-md"> NÃO TEM PROBLEMA!</b> Basta solicitar o
            reembolso e seu dinheiro vai ser devolvido integralmente.
          </p>
          <p className="text-justify text-md leading-5">
            Agora só depende de você, ou você entra e aprende ou vai continuar
            assistindo na plateia .
          </p>
